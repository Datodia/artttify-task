import { Container, SDiv, TxtDiv, Wrapper, HDiv, LogoDiv, HTxt, SecTxt, Desc, RDiv, RewardDiv, TastTxt, GiftDiv, GiftTxt, InsTxt, ImageDiv, GradientDiv, SBtn, QrDiv, QrLogo, QrTxt, DeskImgDiv } from './Main.styled'
const MainCard = () => {
  return (
    <Wrapper>
    <Container>
